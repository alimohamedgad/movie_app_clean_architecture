...
import '../Controller/Details_Bloc/movie_details_bloc.dart';
import '../Controller/Details_Bloc/movie_details_state.dart';
      ...
      builder: (context, state) {
        switch (state.requestState) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetails!.generes)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          case RequestState.erorr:
            return Text(state.movieDetailsMessege);
        }
      },
    );
  }
      ...
      builder: (context, state) {
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: ApiConstance.imageUrl(
                        state.recomindtion[index].backDropPath),
            ...
            childCount: state.recomindtion.length,
          ),
